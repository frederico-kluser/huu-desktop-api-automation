...
describe('input-events.routes', () => {
  ...
  test('deve registrar rota GET /input-events/stats', async () => {
    ...
    // Testar o handler
    const route = registeredRoutes.find(r => r.method === 'GET' && r.path === '/input-events/stats');
    const mockRequest = {};
    const mockReply = {};
  ...
  test('deve registrar rota POST /input-events/clear', async () => {
    ...
    // Testar o handler
    const route = registeredRoutes.find(r => r.method === 'POST' && r.path === '/input-events/clear');
    const mockRequest = {};
    const mockReply = {};
  ...
  test('deve registrar rota POST /input-events/prune', async () => {
    ...
    // Testar o handler
    const route = registeredRoutes.find(r => r.method === 'POST' && r.path === '/input-events/prune');

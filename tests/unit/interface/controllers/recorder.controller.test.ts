...
const { RecorderController } = require('../../../../src/interface/controllers/recorder.controller.js');
const { RecorderListenerService } = require('../../../../src/application/services/recorder-listener.service.js');
...
describe('RecorderController', () => {
  ...
  describe('streamEvents', () => {
    ...
    test('should send initial connected event', async () => {
      ...
      expect(mockReply.raw.write).toHaveBeenCalledWith(expect.stringContaining('"includeScreenshot":true'));
    });

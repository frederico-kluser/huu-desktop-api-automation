...
describe('NutJSMouseAdapter', () => {
  ...
  beforeEach(() => {
    ...
    const { NutJSMouseAdapter } = require('../../../../../src/infrastructure/adapters/nutjs/nutjs-mouse.adapter');
  ...
  describe('edge cases', () => {
    ...
    it('should handle large coordinate values', async () => {
      ...
      expect(mockMouse.move).toHaveBeenCalledWith(
        expect.objectContaining({ x: 5000, y: 3000 })
      );
    });
